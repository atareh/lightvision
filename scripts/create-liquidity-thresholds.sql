...
-- You can add more specific thresholds later or update this one:
-- Example: INSERT INTO liquidity_thresholds (threshold_usd, volume_threshold_usd, notes) VALUES (20000, 5000, 'Increased thresholds Q3');
