...
export function ChartHeader({ title, timeRange, setTimeRange }: ChartHeaderProps) {
  return (
        ...
        {["7D", "30D", "90D", "MAX"].map((period) => (
          <button
            ...
            className={`px-2 py-1 text-xs rounded transition-all duration-200 ${
              timeRange === period ? "bg-[#00c2c2] text-white" : "text-[#868d8f] hover:text-white hover:bg-[#00c2c280]"
            }`}
          >
            {period}
          </button>
